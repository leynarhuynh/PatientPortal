  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-[#12266C]'>
      ...
      <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#FFFFFF] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
        <h1 className='w-full text-3xl font-bold text-[#12266C] m-4'>PatientPortal</h1>
          <li className='p-4 border-b border-gray-600'>Home</li>
          <li className='p-4 border-b border-gray-600'>Patients</li>
